...
`;
        ...
        {layout.header && (
          ...
          >
            ...
            {!isTemplate && (
              <Button
                type="primary"
                className="!me-2 !rounded-none !px-5 !py-[16px] !text-base"
                size="default"
  ...
  function toolbar() {
    return (
      <div
        className="toolbar-theme my-1 flex select-none items-center justify-between overflow-hidden border border-zinc-200 px-5 py-1.5 sm:mx-1 xl:mx-6"
        style={isRtl(i18n.language) ? { direction: "rtl" } : {}}
      >
        <div className="flex justify-start items-center">
          ...
          <Tooltip content={t("zoom_out")} position="bottom">
            <button
              className="py-1 px-2 hover-2 rounded-none text-lg"
              onClick={() =>
                setTransform((prev) => ({ ...prev, zoom: prev.zoom / 1.2 }))
              }
            >
          ...
          <Dropdown
            ...
            trigger="click"
          >
            <div className="flex items-center justify-center rounded-none py-1 px-2 hover-2">
          ...
          <Tooltip content={t("undo")} position="bottom">
            <button
              className="flex items-center rounded-none py-1 px-2 hover-2 disabled:opacity-50"
            ...
            <div className="flex items-center">
              <div className="flex justify-start text-md select-none me-2">
                {Object.keys(menu).map((category) => (
                  ...
                  >
                    <div className="rounded-none px-3 py-1 hover-2">
                      {t(category)}
                    </div>
                  </Dropdown>
                ))}
