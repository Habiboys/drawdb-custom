  ...
  return (
    ...
    >
      <path
        ...
        fill={data.color}
        stroke={hovered || isSelected ? "rgb(37 99 235)" : "rgb(100 116 139)"}
      ...
      >
        <div className="h-full w-full cursor-move select-none rounded-lg px-3 py-2 text-zinc-900">
          <div className="flex justify-between gap-1 w-full">
            <label
              htmlFor={`note_${data.id}`}
              className="ms-5 overflow-hidden text-ellipsis text-sm font-semibold"
            >
              {data.title}
            </label>
            {(hovered ||
